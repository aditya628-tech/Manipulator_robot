...
namespace arduino_bot_cpp_examples
{
    ...
    private:
        ...
        void goalCallback(const rclcpp_action::ClientGoalHandle<arduinobot_msgs::action::Fibonacci>::SharedPtr &goal_handle)
        {
            ...
            {
                RCLCPP_INFO(rclcpp::get_logger("rclcpp"), "Goal was accepted by server. Waiting for result.");
            }
        }
        ...
        void resultCallback(const rclcpp_action::ClientGoalHandle<arduinobot_msgs::action::Fibonacci>::WrappedResult& result)
        {
            switch(result.code)
            {
                ...
                case rclcpp_action::ResultCode::CANCELED:
                    RCLCPP_ERROR(rclcpp::get_logger("rclcpp"), "Goal was cancelled.");
                    return;
...
RCLCPP_COMPONENTS_REGISTER_NODE(arduino_bot_cpp_examples::SimpleActionClient)